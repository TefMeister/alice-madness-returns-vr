...
- **Where the dynamic lights are** (reader, `reader-where-dynamic-lights-are-drawn.md`) `[measured 2026-09-11]`:
  only **17 of the game's 858 map pieces** contain a movable or switchable light, and none a
